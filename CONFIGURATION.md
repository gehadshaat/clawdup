...
> For a step-by-step setup guide, see [GUIDE.md](GUIDE.md). For a quick overview, see [README.md](README.md). For how the pipeline works internally, see the [Architecture & State Flow](ARCHITECTURE.md). For task dependency handling, see [DEPENDENCIES.md](DEPENDENCIES.md).
